...
func NewTestServerContainer(vacancyServer vacancyv1.VacancyServiceServer) (*TestServerContainer, error) {
	...
	vacancyv1.RegisterVacancyServiceServer(grpcServer, vacancyServer)
